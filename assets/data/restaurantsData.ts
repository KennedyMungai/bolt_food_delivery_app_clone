export const dummyRestaurantsData = [
	{
		...
		delivery: '10-20',
		profileImage:
			'https://x7d4c5z5.stackpathcdn.com/wp-content/uploads/tc/2021/03/og-img.jpg',
	...
	},
	{
		...
		about: 'Indulge in the rich flavors of Italy with our handcrafted pasta, wood-fired pizzas, and exquisite wines.',
		food: [
			{
				category: 'Pasta',
				meals: [
	...
	},
	{
		...
		about: 'Experience the finest cuts of beef, expertly grilled to perfection, in an elegant and cozy atmosphere.',
		food: [
			{
				category: 'Steaks',
				meals: [
	...
	},
	{
		...
		delivery: '15-20',
		profileImage:
			'https://images.happycow.net/venues/1024/32/37/hcmp3237_249528.jpeg',
		about: 'Discover a haven of delicious vegetarian and vegan dishes made with fresh, plant-based ingredients.',
		food: [
			{
				category: 'Burgers',
				meals: [
